        ...
        <div class="container text-center">
            ...
            <div class="row h-100">
                <div class="col-lg-8 mx-auto align-self-center">
                    ...
                    <p><img class="avatar avatar-sm" src="{{\Thomaswelton\LaravelGravatar\Facades\Gravatar::src(asset($post->user->email))}}" alt="..."></p>
    ...
    <main class="main-content">
        ...
        <div class="section" id="section-content">
            <div class="container">
                ...
                {!! $post->content !!} <br>
                <a href="{{$post->id}}#disqus_thread">Post a comment</a>
                    ...
                    <div class="col-lg-8 mx-auto">
                        ...
                        <script>
                            ...
                            (function() { // DON'T EDIT BELOW THIS LINE
                                ...
                                s.src = 'https://cms-blog-18.disqus.com/embed.js';
                                s.setAttribute('data-timestamp', +new Date());
                                (d.head || d.body).appendChild(s);
                            })();
                        </script>
                        <script id="dsq-count-scr" src="//cms-blog-18.disqus.com/count.js" async></script>
